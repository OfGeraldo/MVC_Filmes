...
namespace MvcFilmes.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Price,Rating,ReleaseDate")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Price,Rating,ReleaseDate")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
